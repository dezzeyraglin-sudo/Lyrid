...
- Calibration: model under-projects totals by 2.9 runs on average (MAE 4.97)
...
**Acceptance criterion:** After deploy, MAE on totals drops from 4.97 toward 4.0. Bias drops from +2.9 toward ±1.
