...
function buildGameProjection({ awayVsHome, homeVsAway, parkFactor, umpire, weatherImpact, envImpact, conversionRates, odds }) {
  ...
  // Final projections — now including conversion rate, composite environment, and dual-elite
  const projAwayRuns = BASELINE_RUNS * awayComp.lineupMult * awayPitcherBlend * envRunMult * umpRunMult * awayConvMult * dualEliteFactor;
  const projHomeRuns = BASELINE_RUNS * homeComp.lineupMult * homePitcherBlend * envRunMult * umpRunMult * homeConvMult * dualEliteFactor;
