...
const STAT_MAP = {
  ...
  'Rebounds': 'rebounds',
  'Assists': 'assists',
  'Pts+Rebs': 'ptsrebs',      // combo — was dropped before; the slate sums components vs this line
  'Pts+Asts': 'ptsasts',      // combo
  'Rebs+Asts': 'rebasts',     // combo
  'Pts+Rebs+Asts': 'pra',     // combo (already modeled via computePRAProjection)
  '3-PT Made': 'threes',
};
