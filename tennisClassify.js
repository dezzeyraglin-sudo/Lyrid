...
export function tennisClassify(p = {}) {
  ...
  if (market === 'fantasy' && (p.fantasyUnvalidated ?? true))
    return V('UNGRADED', { reason: 'Fantasy composite weights are uncalibrated (UE absorbed into intercept). Do NOT bet until fit against real graded PrizePicks scores.' });
