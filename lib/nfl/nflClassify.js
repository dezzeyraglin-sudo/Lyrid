...
const TIER_PROVISIONAL = {
  GOLD:       { minP: 0.57, minEdge: 0.035 },  // held ~calibrated in Wk1 (5-4, 56% vs 57% claimed)
  PLATINUM:   { minP: 0.66, minEdge: 0.08 },   // raised — overconfident Wk1 (1-2; tiny n) — be more selective
  GUARANTEED: { minP: 0.72, minEdge: 0.13 },   // raised — overconfident Wk1 (4-4, 50% vs 68% claimed; tiny n)
};
